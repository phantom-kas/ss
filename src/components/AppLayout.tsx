      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl border-t border-slate-200 dark:border-slate-700 z-40 safe-area-inset-bottom">
        <div className="flex justify-around items-center h-16 px-2">
          <button
            ...
            className={`flex flex-col items-center justify-center gap-1 flex-1 h-full transition-all ${currentPage === 'dashboard' ? 'text-blue-600' : 'text-slate-500'
              }`}
          >
          ...
          <button
            ...
            className={`flex flex-col items-center justify-center gap-1 flex-1 h-full transition-all ${currentPage === 'send' ? 'text-blue-600' : 'text-slate-500'
              }`}
          >
          ...
          <button
            ...
            className={`flex flex-col items-center justify-center gap-1 flex-1 h-full transition-all ${currentPage === 'transactions' ? 'text-blue-600' : 'text-slate-500'
              }`}
          >
          ...
          <button
            ...
            className={`flex flex-col items-center justify-center gap-1 flex-1 h-full transition-all ${currentPage === 'settings' ? 'text-blue-600' : 'text-slate-500'
              }`}
          >
